...
$settings->add(new admin_setting_configselect('assignment_oj_max_cpu', get_string('maxcpuusage', 'assignfeedback_onlinejudge'),
    get_string('configmaxcpu', 'assignfeedback_onlinejudge'), ASSIGNMENT_ONLINEJUDGE_MAX_CPU,
    get_max_cpu_times()));

$settings->add(new admin_setting_configselect('assignment_oj_max_mem', get_string('maxmemusage', 'assignfeedback_onlinejudge'),
    get_string('configmaxmem', 'assignfeedback_onlinejudge'), ASSIGNMENT_ONLINEJUDGE_MAX_MEM,
    get_max_memory_usages()));