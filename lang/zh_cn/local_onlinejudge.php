...
$string['details'] = '详细信息';
$string['seautherror'] = '用户名或密码错误';
$string['sedelay'] = '发往ideone.com的访问请求之间的时间间隔（秒）';
$string['sedelay_help'] = '向ideone.com发送评测请求和查询结果之间如何间隔太短，会被拒绝访问。这个间隔应该多大？';
$string['seerror'] = 'Ideone返回错误：{$a}';
$string['selogo'] = '<a href="https://github.com/hit-moodle/moodle-local_onlinejudge">Moodle在线评测</a>使用了<a href="http://sphere-research.com">Sphere Research Labs</a>提供的<a href="http://ideone.com">Ideone API</a> &copy;';
$string['seresultlink'] = '在<a href="http://ideone.com/{$a}">http://ideone.com/{$a}</a>查看更多信息。';
$string['seuserrequired'] = '如果选择了用ideone.com评测，就必须输入';
$string['info'] = '信息';
